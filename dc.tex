...
\tabref{tab:dccost} includes an Engineering team, a management team and and a scientific support team.
Several personnel models for this sort of center were presented in \cite{2023arXiv231104272B}.

We should consider DSA-2000 already have private funding and would like a cloud archive - it would give one ready data set and partner.

\input{dccost.tex}

If this was funded as endowment over 20 years a cost model is shown in \tabref{tab:endowment}
\input{endowment}
